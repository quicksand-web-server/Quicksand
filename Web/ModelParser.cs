...
{
    /// <summary>
    /// Exception thrown when <seealso cref="ModelParser"/> try to load a misformatted HTML file
    /// </summary>
    ...
    /// <summary>
    /// Exception thrown when <seealso cref="ModelParser"/> try to load a misformatted QSML file
    /// </summary>
    ...
    public static class ModelParser
    {
        ...
        {
            if (File.Exists(path))
                return LoadFromContent(File.ReadAllText(path));
